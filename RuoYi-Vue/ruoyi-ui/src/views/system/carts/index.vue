<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="主键ID" prop="cartId">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:carts:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:carts:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="cartsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="主键ID" align="center" prop="cartId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="主键ID" prop="cartId">
          <el-input v-model="form.cartId" placeholder="请输入主键ID" />
        </el-form-item>
        <el-form-item label="用户ID" prop="userId">
...
<script>
import { listCarts, getCarts, delCarts, addCarts, updateCarts } from "@/api/system/carts";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除购物车视图编号为"' + cartIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/carts/export', {
        ...this.queryParams
